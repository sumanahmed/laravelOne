                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            @foreach($products as $product)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a href="{{ url('/view-product/'.$product->id) }}" class="btn btn-info btn-xs" title="View Product"> <span class="glyphicon glyphicon-zoom-in"></span></a>
                                        @if($product->publication_status == 1)
                                            <a href="{{ url('/unpublished-product/'.$product->id) }}" class="btn btn-success btn-xs" title="Published Product"> <span class="glyphicon glyphicon-arrow-up"></span></a>
                                        @else
